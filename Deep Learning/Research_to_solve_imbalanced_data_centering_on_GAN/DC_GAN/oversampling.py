...
import torch
from model_dcgan import Discriminator,Generator # 변경
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ngf', type=int,default=64, help="path to netG (to continue training)")
    parser.add_argument('--counts', type=int)
    parser.add_argument('--model_name', help='Normal_GAN | DC_GAN')
    parser.add_argument('--model_epoch', type=str)
    parser.add_argument('--save', type=bool)
    parser.add_argument('--ngpu', type=int, help='num of gpu', default=1) #추가
...
#    path=r'.\models\G.pkl'
    ...
    model=Generator(opt.ngpu, n_noise, ngf=opt.ngf, nc=opt.nc).to(DEVICE) # 변경
